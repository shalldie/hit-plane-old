...
localStorage['hitplane-source'] = JSON.stringify({
    imgPlane: require("!url!./plane.png"),
    imgBoom: require("!url!./boom.png"),
    imgBulletArr: [  // 子弹数组
        require("!url!./bullet01.png"), // 基础子弹
        require("!url!./bullet02.png"), // 二级子弹
        require("!url!./bullet03.png"),  // 三级子弹
    ...
    imgHP: require("!url!./hp.png"),
    imgEnemy: require("!url!./enemy.png"),
    imgHeart: require("!url!./heart.png")
});